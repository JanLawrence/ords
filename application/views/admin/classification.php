        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="text-right">
                    <a href="#" class="btn btn-secondary btn-sm mb-4" data-toggle="modal" data-target="#addModal"><i class="ti-plus"></i> Add Classification</a>
                </div>
                <table class="table table-bordered table-striped table-hovered" id="tableList">
                    ...
                    <tbody>
                        ...
                        <?php 
                            $ctr = 1;
                            foreach($classification as $each){
                        ?>
                            <tr>
                                <td><?= $ctr++?></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4><i class="ti-plus"></i> Add Classification</h4>
            </div>
...
<div class="modal" id="editModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4><i class="ti-pencil-alt"></i> Edit Classification</h4>
            </div>
            <form id="editForm">
                <div class="modal-body">
                    <div class="row">
...
<script src="<?= base_url()?>assets/modules/js/classification.js"></script>