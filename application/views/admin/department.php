        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="text-right">
                    <a href="#" class="btn btn-secondary btn-sm mb-4" data-toggle="modal" data-target="#addModal"><i class="ti-plus"></i> Add Department</a>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4><i class="ti-plus"></i> Add Department</h4>
            </div>
...
<div class="modal" id="editModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4><i class="ti-pencil-alt"></i> Edit Department</h4>
            </div>
            <form id="editForm">
                <div class="modal-body">
                    <div class="row">
...
<script src="<?= base_url()?>assets/modules/js/department.js"></script>