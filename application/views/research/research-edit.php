                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        Research: <br><br>
                                        <input type="radio" name="class_research" value="Basic" required <?= $research[0]->class_research == 'Basic' ? 'checked' : ''?>> Basic <br>
                                        <input type="radio" name="class_research" value="Applied" required  <?= $research[0]->class_research == 'Applied' ? 'checked' : ''?>> Applied <br> <br>
                                        Development: <br><br>
                                        <input type="radio" name="class_dev" required value="Pilot Testing"  <?= $research[0]->class_development == 'Pilot Testing' ? 'checked' : ''?>> Pilot Testing <br>
                                        <input type="radio" name="class_dev" required value="Tech. Promotion/ Commercialization"  <?= $research[0]->class_development == 'Tech. Promotion/ Commercialization' ? 'checked' : ''?>> Tech. Promotion/ Commercialization
                                    </div>    
                                </td>
                                <td>
                                    <div class="form-group">
